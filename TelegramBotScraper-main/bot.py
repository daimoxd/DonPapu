...
addusr = ""
tk = os.getenv("12da82a7-66df-4e69-9f0b-4422c27b6708")
mode = os.getenv("No se")

posting_channel = os.getenv("5035421949")
...
if mode == "dev":
	...
	def run(updater):
		...
		HEROKU_APP_NAME = os.environ.get("ccbotscrapperdonpapu")
...
@run_async
def start(update):
	update.message.reply_text("This CC Scraper has been started successfully | Developed by Dᴏɴ Pᴀᴘᴜ ⚘ΔĐ𐌔➳")
